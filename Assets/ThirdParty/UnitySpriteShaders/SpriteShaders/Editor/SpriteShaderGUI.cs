...
public class SpriteShaderGUI : ShaderGUI
{
	...
	private MaterialProperty _displaceColor = null;
	...
	protected virtual void FindProperties(MaterialProperty[] props)
	{
		...
		_displaceColor = FindProperty("_DisplaceColor", props);
		_targetColor = FindProperty("_TargetColor", props);
	...
	protected virtual bool RenderTextureProperties()
	{
		...
		_materialEditor.ColorProperty( _displaceColor, "Color Displace");
		_materialEditor.ColorProperty( _targetColor, "Color Target");
